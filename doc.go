/*
A driver for the go-strm library, that provides the SELECT command.
...
Or:
	...
	import (
		_ "github.com/reiver/strm-select"
	)

If you use the 1st style -- the dot import -- then the SELECT constant will be made available,
